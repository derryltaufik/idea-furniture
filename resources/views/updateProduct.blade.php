                ...
                <div class="card-body">
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="productType" class="form-control @error('productType') is-invalid @enderror" name="productType">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="stock" type="text" class="form-control @error('stock') is-invalid @enderror" name="stock" value="{{ $product->stock }}">
